...
| Conference | Checklist Required | Items | Location |
|------------|-------------------|-------|----------|
| **NeurIPS 2025** | Yes | 16 items | After references |
| **ICML 2026** | Yes | Reproducibility + Broader Impact | Before references |
| **ICLR 2026** | Partial | LLM disclosure required | Appendix |
| **ACL 2025** | Yes | Limitations mandatory | Main paper |
| **AAAI 2026** | Yes | Various | After references |
| **COLM 2025** | Yes | LLM disclosure | Appendix |
...
### AAAI Specific Checklist

#### Style Compliance
- [ ] Official AAAI template used
- [ ] No modifications to style file
- [ ] Page limit respected (7 pages)
- [ ] All fonts/sizes correct

#### Supplementary Material
- [ ] Clearly labeled in main paper
...
- [ ] Anonymous links used if needed

---

## COLM Requirements

### COLM Specific Checklist

#### LLM Disclosure
- [ ] LLM usage disclosed if significant
- [ ] Role of LLM clearly described
- [ ] Separate appendix section if required

#### Language Model Focus
- [ ] Paper focuses on language models
- [ ] Empirical, theoretical, or conceptual contribution clear
- [ ] Interdisciplinary relevance explained
...
- ICML: https://icml.cc/Conferences/2024/PaperGuidelines
...
**See also:**
- `reviewer_guidelines.md` - How reviewers evaluate papers
